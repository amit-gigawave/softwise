...
export const AgenticAI = () => {
    return (
        <section id="agentic-ai" className="relative py-12 md:py-24 overflow-hidden bg-transparent">
            {/* Ambient Background Elements */}
            <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-primary/10 blur-[120px] rounded-full pointer-events-none" />
            <div className="absolute bottom-0 right-1/4 w-[600px] h-[600px] bg-secondary/10 blur-[150px] rounded-full pointer-events-none" />

            <div className="container mx-auto px-6 max-w-7xl relative z-10">
                {/* Hero Header */}
                <div className="text-center mb-24">
                    <SectionBadge text="The Future of Autonomy" />
                    ...
                    <motion.h2
                        ...
                        className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight text-primary mb-8 leading-[1.1] glow-primary"
                    >
                        Beyond prompts. <br />
                        <span className="text-secondary/60 italic font-light tracking-tighter glow-secondary">Enter the era of Agency.</span>
                    </motion.h2>
                    ...
                    <motion.p
                        ...
                        className="text-lg text-secondary/80 max-w-2xl mx-auto font-medium leading-relaxed"
                    >
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center bg-zinc-900/50 rounded-[3rem] border border-white/5 p-8 md:p-16 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <h3 className="text-3xl md:text-4xl font-bold text-primary mb-6">The Evolutionary Shift</h3>
                        <p className="text-lg text-secondary/80 mb-8 font-medium">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center p-8">
                            <div className="w-full h-full bg-zinc-900/80 rounded-2xl border border-white/10 p-6 relative overflow-hidden shadow-2xl">
                                ...
                                <div className="space-y-4 font-mono text-xs">
                                    <p className="text-primary">{">"} INITIALIZING_AGENTIC_CORE...</p>
                                    <p className="text-secondary/60">{">"} LOADING MISSION CONTEXT: "Optimize Supply Chain Hub"</p>
                                    <p className="text-secondary">{">"} PLANNING_PHASE: 4 STEPS IDENTIFIED</p>
                                    <div className="pl-4 space-y-2 border-l border-zinc-800 ml-2">
                                        <p className="text-secondary/80">1. Querying SAP Inventory API...</p>
                                        <p className="text-secondary/80">2. Analyzing lead times (ML-Model 4)</p>
                                        <p className="text-secondary/80">3. Draft procurement emails (Drafts Box)</p>
                                        <p className="text-secondary/80">4. Notify operation leads (Slack)</p>
                                    </div>
                                    <p className="text-primary animate-pulse">{">"} EXECUTING STEP 1: SUCCESS (2.4s)</p>
                                </div>

                                {/* Decorative scan line */}
                                <div className="absolute top-0 left-0 w-full h-px bg-primary/20 blur-sm animate-[scan_4s_linear_infinite]" />
                            </div>
                        </div>
                    </div>
                </div>
